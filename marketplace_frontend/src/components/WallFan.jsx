    ...
    const renderDivs = () => {
        ...
        for (let i = 0; i < 6; i++) {
            divs.push(
                ...
                >
                    <img src={fan04} alt="Ventilador" style={{}} />
                    <div
                        style={{
                            display: "flex",
                            alignItems: "center",
                    ...
                    >
                        <Typography variant="h6" style={{ lineHeight: "16px" }}>
                            Ventilador Vento Fresco Force Breeze Parede 50cm
                        </Typography>
                        <Favorite />
                    </div>
                    <div
                    ...
                    >
                        <Typography variant="h4">R$ 499,99</Typography>
                        <Typography variant="body1">à vista</Typography>
                    </div>
                    <Link to="wallfanpg" target='_blank' style={{
                        display: "flex",
...
const WallFan = () => {
    return (
        ...
        <div style={{
            ...
            <Typography variant='h2'>Ventiladores de Parede</Typography>
            <ProductCards />
        </div>
