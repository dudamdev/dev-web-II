    ...
    const renderDivs = () => {
        ...
        for (let i = 0; i < 6; i++) {
            divs.push(
                ...
                >
                    <img src={fan02} alt="Ventilador" style={{}} />
                    <div
                        style={{
                            display: "flex",
                            alignItems: "center",
                    ...
                    >
                        <Typography variant="h6" style={{ lineHeight: "16px" }}>
                            Ventilador Vento Fresco Force Breeze Coluna 120cm
                        </Typography>
                        <Favorite />
                    </div>
                    <div
                    ...
                    >
                        <Typography variant="h4">R$ 399,99</Typography>
                        <Typography variant="body1">à vista</Typography>
                    </div>
                    <Link to="columnfanpg" target='_blank' style={{
                        display: "flex",
...
const ColumnFan = () => {
    return (
        ...
        <div style={{
            ...
            <Typography variant='h2'>Ventiladores de Coluna</Typography>
            <ProductCards />
        </div>
