    ...
    const renderDivs = () => {
        ...
        for (let i = 0; i < 6; i++) {
            divs.push(
                ...
                >
                    <img src={fan01} alt="Ventilador" style={{}} />
                    <div
                        style={{
                            display: "flex",
                            alignItems: "center",
                    ...
                    >
                        <Typography variant="h6" style={{ lineHeight: "16px" }}>
                            Ventilador Vento Fresco Force Breeze Mesa 40cm
                        </Typography>
                        <Favorite />
                    </div>
                    <div
                    ...
                    >
                        <Typography variant="h4">R$ 299,99</Typography>
                        <Typography variant="body1">à vista</Typography>
                    </div>
                    <Link to="tablefanpg" target='_blank' style={{
                        display: "flex",
...
const TableFan = () => {
    return (
        ...
        <div style={{
            ...
            <Typography variant='h2'>Ventiladores de Mesa</Typography>
            <ProductCards />
        </div>
