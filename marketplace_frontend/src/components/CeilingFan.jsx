    ...
    const renderDivs = () => {
        ...
        for (let i = 0; i < 6; i++) {
            divs.push(
                ...
                >
                    <img src={fan03} alt="Ventilador" style={{}} />
                    <div
                        style={{
                            display: "flex",
                            alignItems: "center",
                    ...
                    >
                        <Typography variant="h6" style={{ lineHeight: "16px" }}>
                            Ventilador Vento Fresco Force Breeze Teto 50cm
                        </Typography>
                        <Favorite />
                    </div>
                    <div
                    ...
                    <Link to="ceilingfanpg" target='_blank' style={{
                        display: "flex",
...
const CeilingFan = () => {
    return (
        ...
        <div style={{
            ...
            <Typography variant='h2'>Ventiladores de Teto</Typography>
            <ProductCards />
        </div>
