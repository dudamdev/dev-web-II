...
import fan01 from "../../src/images/fan01.png";
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={fan01} alt="Ventilador de Mesa" style={{
                        width: "500px",
                        borderRadius: "8px"
                    }} />
                    <div style={{
                        ...
                        <Typography variant="h2">Ventilador Vento Fresco Force Breeze Mesa 40cm</Typography>
                        <div>
                            ...
                            <Typography variant="body1">Ventilador de Mesa Vento Fresco Force Breeze, perfeito para qualquer tipo de ambiente.</Typography>
                            <Typography variant="body1">Possui 3 velocidades e 40cm de diâmetro.</Typography>
                        </div>
                        <VoltageRadio />
                        <div>
                            <div style={{
                                ...
                                <Typography variant="h3" style={{ color: colors.blueAccent[200], fontWeight: "700", fontSize: "2em" }}>R$ 299,99</Typography>
