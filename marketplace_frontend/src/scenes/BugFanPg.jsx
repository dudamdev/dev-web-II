        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={fan05} alt="Ventilador de Mesa" style={{
                        width: "500px",
                        borderRadius: "8px"
                    }} />
                    <div style={{
                        ...
                        <Typography variant="h2">Ventilador Vento Fresco Force Breeze Repelente 40cm</Typography>
                        <div>
                            ...
                            <Typography variant="body1">Ventilador Repelente Vento Fresco Force Breeze, perfeito para qualquer tipo de ambiente.</Typography>
                        ...
                        <div>
                            <div style={{
                                ...
                                <Typography variant="h3" style={{ color: colors.blueAccent[200], fontWeight: "700", fontSize: "2em" }}>R$ 599,99</Typography>
