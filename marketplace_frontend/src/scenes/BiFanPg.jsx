        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={fan06} alt="Ventilador de Mesa" style={{
                        width: "500px",
                        borderRadius: "8px"
                    }} />
                    <div style={{
                        ...
                        <Typography variant="h2">Ventilador Vento Fresco Force Breeze 2em1</Typography>
                        <div>
                            ...
                            <Typography variant="body1">Ventilador 2 em 1 Vento Fresco Force Breeze, perfeito para qualquer tipo de ambiente.</Typography>
                            <Typography variant="body1">Possui 3 velocidades e 40cm a 120cm de diâmetro.</Typography>
                        </div>
                        <VoltageRadio />
                        <div>
                            <div style={{
                                ...
                                <Typography variant="h3" style={{ color: colors.blueAccent[200], fontWeight: "700", fontSize: "2em" }}>R$ 699,99</Typography>
