...
import fan02 from "../../src/images/fan02.png";
...
const rows = [
    createData('Conteúdo da Embalagem', "1 ventilador + 1 coluna de ventilador + 1 manual de instruções"),
    createData('Cor', "Preto e Cinza"),
    createData('Potência (Watts)', "50W"),
    createData('Número de Velocidades', "3"),
    createData('Garantia', "12 meses por defeitos de fabricação"),
    createData('Tipo de Material', "Polipropileno - PP"),
    createData('Peso', "2.5kg"),
];
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={fan02} alt="Ventilador de Mesa" style={{
                        width: "500px",
                        borderRadius: "8px"
                    }} />
                    <div style={{
                        ...
                        <Typography variant="h2"> Ventilador Vento Fresco Force Breeze Coluna 120cm</Typography>
                        <div>
                            ...
                            <Typography variant="body1">Ventilador de Coluna Vento Fresco Force Breeze, perfeito para qualquer tipo de ambiente.</Typography>
                            <Typography variant="body1">Possui 3 velocidades e 120cm de diâmetro.</Typography>
                        </div>
                        <VoltageRadio />
                        <div>
                            <div style={{
                                ...
                                <Typography variant="h3" style={{ color: colors.blueAccent[200], fontWeight: "700", fontSize: "2em" }}>R$ 399,99</Typography>
