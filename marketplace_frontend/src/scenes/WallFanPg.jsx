...
import fan04 from "../../src/images/fan04.jpg";
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={fan04} alt="Ventilador de Mesa" style={{
                        width: "500px",
                        borderRadius: "8px"
                    }} />
                    <div style={{
                        ...
                        <Typography variant="h2">Ventilador Vento Fresco Force Breeze Parede 50cm</Typography>
                        <div>
                            ...
                            <Typography variant="body1">Ventilador de Parede Vento Fresco Force Breeze, perfeito para qualquer tipo de ambiente.</Typography>
